                ...
                <div class="media">
                    <span class="float-left m-2 mr-4">
                        @isset($user->profil->avatar)
                            <img src="{{ asset('storage/' . $user->profil->avatar) }}" width="100" height="100" alt="Avatar"
                                loading="lazy" class="rounded-circle avatar-lg img-thumbnail" />
                        @else
                            <img src="{{ asset('assets/images/avatars/avatar_default.webp') }}" width="100" height="100"
                                alt="Avatar" loading="lazy" class="rounded-circle avatar-lg img-thumbnail" />
                        @endisset
                    </span>
                    ...
                    <div class="media-body">
                        ...
                        <ul class="list-inline text-light mb-0">
                            <li class="list-inline-item mr-3">
                                ...
                                <p class="font-13 text-white-50 mb-0">Status</p>
                            </li>

                            <li class="list-inline-item">
                                <h5 class="mb-1 text-white">{{ $user->divisi->nama_divisi }}</h5>
                                <p class="font-13 text-white-50 mb-0">{{ $user->seksi }}</p>
                            </li>
                        </ul>
                    </div>
                </div>
