                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input
                                                    ...
                                                    id="header_{{ $menuHeader->id }}"
                                                    type="checkbox"
                                                    class="custom-control-input form-control-lg menu-headers"
                                                    data-header="header_{{ $menuHeader->id }}"

                                                    @if (
                                                        isset($user->menuHeader->find($menuHeader->id)->pivot) &&
                                                        $user->menuHeader->find($menuHeader->id)->pivot->read
                                                    )
                                                        checked
                                                    @endif
                                                />
                                        ...
                                        <div class="col-md-2 col-sm-6 mb-1">
                                            <div class="custom-control custom-checkbox">
                                                <input
                                                    ...
                                                    @if (
                                                        isset($user->menuItem->find($menuItem->id)->pivot) &&
                                                        $user->menuItem->find($menuItem->id)->pivot->create == 1
                                                    )
                                                        checked
                                                    @endif
                                                    ...
                                                    @if (
                                                        !isset($user->menuHeader->find($menuHeader->id)->pivot) ||
                                                        $user->menuHeader->find($menuHeader->id)->pivot->read != 1
                                                    )
                                                        disabled
                                                    @endif
                                                />
                                        ...
                                        <div class="col-md-2 col-sm-6 mb-1">
                                            <div class="custom-control custom-checkbox">
                                                <input
                                                    ...
                                                    @if (
                                                        isset($user->menuItem->find($menuItem->id)->pivot) &&
                                                        $user->menuItem->find($menuItem->id)->pivot->read == 1
                                                    )
                                                        checked
                                                    @endif
                                        ...
                                        <div class="col-md-2 col-sm-6 mb-1">
                                            <div class="custom-control custom-checkbox">
                                                <input
                                                    ...
                                                    @if (
                                                        isset($user->menuItem->find($menuItem->id)->pivot) &&
                                                        $user->menuItem->find($menuItem->id)->pivot->update == 1
                                                    )
                                                        checked
                                                    @endif
                                        ...
                                        <div class="col-md-2 col-sm-6 mb-1">
                                            <div class="custom-control custom-checkbox">
                                                <input
                                                    ...
                                                    @if (
                                                        isset($user->menuItem->find($menuItem->id)->pivot) &&
                                                        $user->menuItem->find($menuItem->id)->pivot->delete == 1
                                                    )
                                                        checked
                                                    @endif
