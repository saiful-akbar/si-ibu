                            ...
                            <div class="col-md-9 col-sm-12">
                                ...
                                >
                                    ...
                                    @foreach ($divisions as $divisi)
                                        <option
                                            value="{{ $divisi->id }}"
                                            @if (old('divisi_id', $budget->divisi_id) == $divisi->id) selected @endif
                                        >
                                            {{ $divisi->nama_divisi }}
                                        </option>
                                    @endforeach
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="input-group col-md-9 col-sm-12">
                                ...
                                <input
                                    ...
                                    class="d-none"
                                    value="{{ old('jenis_belanja_id', $budget->jenisBelanja->id) }}"
                                    required
                                >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 col-sm-12 input-group">
                                ...
                                <input
                                    ...
                                    id="sisa_nominal"
                                    name="sisa_nominal"
                                    placeholder="Masukan sisa_nominal..."
                                    min="0"
