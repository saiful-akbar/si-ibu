...
@section('btn-kembali')
    <a href="{{ route('akun-belanja') }}" class="btn btn-rounded btn-light btn-sm">
...
@section('content')
    <form action="{{ route('akun-belanja.store') }}" method="POST" autocomplete="off">
        @csrf
        @method('POST')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header pt-3">
                        <h4 class="header-title">Form tambah akun belanja</h4>
                    </div>
                            ...
                            <div class="col-md-9 col-sm-12">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" name="active" class="custom-control-input form-control-lg"
                                        id="active" @if (old('active', 1)) checked @endif value="1" />
