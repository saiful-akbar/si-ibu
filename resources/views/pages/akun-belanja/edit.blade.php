...
@section('content')
    <form
        action="{{ route('akun-belanja.update', ['akunBelanja' => $akunBelanja->id]) }}"
        method="POST"
        autocomplete="off"
    >
        @csrf
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9 col-sm-12">
                                <input
                                    ...
                                    class="form-control @error('nama_akun_belanja') is-invalid @enderror"
                                    required
                                />
                            ...
                            <div class="col-md-9 col-sm-12">
                                <div class="custom-control custom-switch">
                                    <input
                                        ...
                                        id="active"
                                        @if (old('active', $akunBelanja->active)) checked @endif
                                        value="1"
                                    />
